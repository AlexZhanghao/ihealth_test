...
//int RFPassiveTrain::LoadDocumentInfo() {
//	CTask::Assign(CTask::NotWait, Panic(), NULL, EventHandle(&RFMySQLThread::LoadDocumentInfo), RFMainWindow::UIThread, RFMainWindow::DBThread);
//	return 1;
//}
